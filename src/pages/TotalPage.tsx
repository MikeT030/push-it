...
import { TrendingUp, Flame, Calendar, ChevronDown, ChevronRight, Wrench, BookOpen, Lightbulb } from "lucide-react";
...
const TotalPage = () => {
  ...
  return <div className="min-h-screen bg-background pb-32 safe-top">
      ...
      <div className="relative max-w-lg mx-auto px-6 space-y-3 py-[32px]">
        ...
        <header className="animate-fade-in">
          <div className="flex items-center justify-between">
            <h2 className="text-sm text-[#ffffff] font-medium uppercase tracking-wide">
