...
const TotalPage = () => {
  ...
  return <div className="min-h-screen bg-background pb-32 safe-top">
      ...
      <div className="relative max-w-lg mx-auto px-6 py-8">
        ...
        {/* Main Progress Card */}
        <div className="rounded-2xl p-6 mt-6 animate-slide-up bg-[#182734]">
        ...
        <div className="grid grid-cols-2 gap-4 mt-6">
          ...
          return <div key={stat.label} className={`bg-[#182734] rounded-2xl p-5 animate-slide-up ${isClickable ? "cursor-pointer hover:opacity-90 active:scale-[0.98] transition-all" : ""}`} style={{
