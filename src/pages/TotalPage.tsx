              ...
              <div className="flex items-center gap-6 mx-[10px]">
                <div className="flex-1 flex items-start gap-8">
                  ...
                  <div className="relative flex flex-col items-center">
                    ...
                    {showGoalAdjust && (
                      <div
                        className="absolute z-20 top-full left-1/2 -translate-x-1/2 -ml-[30px] mt-2 rounded-xl p-2 backdrop-blur-xl bg-white/5 border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] flex flex-col gap-1.5 animate-fade-in items-center"
                      >
                        {goalBoost > 0 && (
                          <button
                            type="button"
