...
const ProfilePage = () => {
  ...
  return <div className="min-h-screen bg-background pb-32 safe-top">
      <div className="px-6 pt-12">
        ...
        {/* Profile Card */}
        <div className="bg-card/40 rounded-2xl p-6 animate-slide-up pt-[10px] pb-[10px] mb-[10px] px-[10px]">
          {/* Avatar */}
        ...
        {/* Admin Card */}
        {isAdmin && (
          <div className="bg-card/40 rounded-2xl p-6 mt-6 animate-slide-up pt-[10px] pb-[10px] mb-[10px] px-[10px]" style={{ animationDelay: "0.03s" }}>
        ...
        {/* Info Card */}
        <div className="bg-card/40 rounded-2xl p-6 mt-6 animate-slide-up pt-[10px] pb-[10px] mb-[10px] px-[10px]" style={{
        animationDelay: "0.1s"
      }}>
