          ...
          <div className="space-y-4">
            <div>
              ...
              {isEditing ? <div className="flex gap-2 mt-1.5">
                  <Input value={editValue} onChange={e => setEditValue(e.target.value)} maxLength={30} placeholder="Enter your nickname" className="h-12 bg-transparent border-0 border-b border-input" autoFocus />
