...
const LeaderboardListView = ({ users }: {users: UserProgress[];}) => {
  ...
  return (
    <div className="rounded-2xl overflow-hidden animate-slide-up" style={{ background: "rgba(42,47,58,0.70)" }}>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <div onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} className="touch-pan-y">
            ...
            <TabsContent value="stats" className="mt-0">
              ...
              {/* Goal Card */}
              <div className="rounded-2xl p-6 mb-6 animate-slide-up" style={{
