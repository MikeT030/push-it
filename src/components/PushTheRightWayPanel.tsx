    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      >
        <div className="safe-top px-6 pt-6 pb-12 max-w-lg mx-auto">
          ...
          <div className="bg-card/40 border border-transparent rounded-2xl p-5 mb-4">
          ...
          <section className="bg-card/40 border border-[#3B404F] rounded-2xl p-5 mb-4">
            ...
            <div className="space-y-6" style={{ color: BODY_TEXT }}>
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed">Doing any repetitive motion daily leaves little time for systemic recovery. Your wrists, elbows, and shoulders bear the brunt of the load without a break, increasing the risk of tendonitis.</p>
              </div>
            </div>
          </section>
