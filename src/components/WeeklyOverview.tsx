  ...
  return <Collapsible open={isOpen} onOpenChange={setIsOpen} className="col-span-2">
      ...
      animationDelay: "0.25s"
        ...
        <CollapsibleTrigger asChild>
          <button className="flex items-center justify-between w-full text-left hover:opacity-80 transition-opacity mb-[6px] mt-[10px] px-[10px] pt-[10px] pb-[10px] rounded-2xl border-0">
