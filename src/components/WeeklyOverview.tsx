...
const WeeklyOverview = () => {
  ...
  return <Collapsible open={isOpen} onOpenChange={setIsOpen} className="col-span-2">
      <div className="bg-card/40 rounded-2xl p-6 animate-slide-up" style={{
      animationDelay: "0.25s"
    }}>
        <CollapsibleTrigger asChild>
          <button className="flex items-center justify-between w-full text-left hover:opacity-80 transition-opacity mb-[10px]">
