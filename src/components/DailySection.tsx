    ...
    <>
      ...
      <div className="bg-card/40 rounded-2xl p-6 mb-6 animate-slide-up" style={{ animationDelay: "0.05s" }}>
        ...
        {(() => {
          ...
          const items = [
            { label: "Most logged", value: maxDay, unit: "PU/day", Icon: MuscleIcon, color: "text-primary", isCustomIcon: true },
      ...
      <button
        ...
        style={{ background: 'rgba(42,47,58,0.70)' }}
        className={`w-full rounded-2xl p-3 py-8 animate-slide-up transition-all duration-300 ease-out hover:opacity-90 ${isCalendarOpen ? "rounded-b-none mb-0 pb-4" : "mb-3"}`}
