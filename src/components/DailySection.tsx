    ...
    <>
      ...
      <div className="relative p-6 pt-[20px] px-[10px] pb-[2px]">
        ...
        {(() => {
          ...
          return (
            <div className="flex gap-4 pt-4 mt-2 border-t border-b border-[#3B404F] mb-2 overflow-x-auto pb-[20px] mx-[2px]" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
      ...
      >
        ...
        <div
          ...
          className="flex gap-2 overflow-x-auto scrollbar-hide snap-x snap-mandatory pt-[4px] pb-[4px] mx-[10px]"
        >
          {miniDays.map((day) => {
