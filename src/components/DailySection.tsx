  ...
  return (
    <>
      ...
      <button
        ...
        className={`w-full bg-card/40 rounded-2xl p-3 py-8 animate-slide-up transition-all duration-300 ease-out hover:opacity-90 ${isCalendarOpen ? "rounded-b-none mb-0 pb-4" : "mb-3"}`}
