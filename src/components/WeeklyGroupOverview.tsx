              ...
              <div key={format(day.date, "yyyy-MM-dd")}>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-foreground w-8 text-left">{format(day.date, "MMM")}</span>
                    <span className="text-sm text-foreground w-5 text-left">{format(day.date, "d")}</span>
                    {day.isToday && (
